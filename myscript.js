...
window.addEventListener("load", () => {
  let split = new SplitText(".introduction", {
...
window.addEventListener("load", () => {
  let split = new SplitText(".project-hero-title, .project-hero-question, .project-hero-copy, .project-meta-heading, .project-meta-list", {
    type: "lines, words, chars"
  });
...
elements.forEach(element => {
  ...
  // second block (for the rollover state)
...
document.querySelectorAll(".project-gallery").forEach(gallery => {
  const mainImg = gallery.querySelector("#project-main-image");
